 ...
 * @author rafae
 */
public class Display3b extends javax.swing.JFrame {
    
    private PreparedStatement pre;
    private Connection conn;
    /**
     * Creates new form Display3b
     */
    public Display3b() {
        initComponents();
    }
    ...
    private void jPanel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel2MouseClicked
        ...
        try {
            ...
            pre = conn.prepareStatement("UPDATE admin SET name = ?, username = ?, password = ? WHERE password = ?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Display3b.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
